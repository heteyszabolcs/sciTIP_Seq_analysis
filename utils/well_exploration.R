...
write_tsv(all_wells_df, "../data/count_tables/20230510_scTIP_read_sums.tsv")
...
write_tsv(all_counts, "../data/count_tables/20230510_read_counts-cells_above_1000reads.tsv")
