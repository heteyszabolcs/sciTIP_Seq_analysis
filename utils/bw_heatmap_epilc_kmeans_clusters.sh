...
# computeMatrix reference-point -o \
 # ../results/deeptools/matrix_clusters_summary.gz \
...
plotHeatmap -m ../results/deeptools/matrix_clusters_summary.gz \
 -out "../results/deeptools/Yang_EpiLC_K27ac_kmeans-clusters.pdf" \
